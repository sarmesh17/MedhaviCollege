...
fun BBAPrograms(
    ...
    Column(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(15.dp), verticalAlignment = Alignment.CenterVertically, modifier = Modifier
            ...
            Text(text = "BBA Program", fontSize = 20.sp, color = colorResource(id = R.color.black))

        }

        Image(painter = painterResource(id = R.drawable.bba), contentDescription = null)
        ...
        Box(
            ...
            Text(text = "BBA", fontSize = 36.sp, fontWeight = FontWeight.Bold, color = colorResource(
                id = R.color.black
            )
            )
        }
        ...
        Text(text = stringResource(id = R.string.bba), textAlign = TextAlign.Justify, fontSize = 16.sp, lineHeight = 25.sp, modifier = Modifier.padding(top = 5.dp, start = 10.dp, end = 10.dp), color = colorResource(
            id = R.color.black
        )
        )
    }
