...
fun BHMPrograms(
    ...
    Column(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(15.dp), verticalAlignment = Alignment.CenterVertically, modifier = Modifier
            ...
            Text(text = "BHM Program", fontSize = 20.sp, color = colorResource(id = R.color.black))

        }

        Image(painter = painterResource(id = R.drawable.bhm), contentDescription = null)
        ...
        Box(
            ...
            Text(
                text = "BHM", fontSize = 36.sp, fontWeight = FontWeight.Bold, color = colorResource(
                    id = R.color.black
                )
            )
        }
        ...
        Text(
            text = stringResource(id = R.string.bhm),
